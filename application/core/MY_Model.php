...
class MY_Model extends CI_Model {
	...
	$this->_set_where($where);
	//$this->_database->order_by('expiry_date','desc');
	return $this->get_all();
    }
...
//    }
     ...
     * Update record.
     */
    public function update_obj($primary_value) {
...
//	}
     ...
     */
    public function join_get($select, $table1, $table2, $where1, $where2, $orderby, $limit ) {
	$sql = "SELECT $select FROM $table1 t1, $table2 t2 WHERE t1.$where1 = t2.$where2 ORDER BY '$orderby' LIMIT $limit";
