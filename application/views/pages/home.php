<div id="main-img" style="position: fixed;width:100%;background: url('<?php echo base_url(); ?>assets/themes/default/images/akaroa.jpg');">
    <div class="slider-container">
        <script src="<?php echo base_url(); ?>assets/themes/default/js/scripts.js"></script>
        <div id="layerslider_29" class="ls-wp-container" style="width:1280px;height:720px;max-width:1280px;margin:0 auto;margin-bottom: 0px;">

            <div class="ls-slide" data-ls="slidedelay:8000;transition2d:75,79;">
                <img class="ls-l" style="top:180px;left:0;width:765px;white-space: nowrap;" data-ls="offsetxin:0;offsetyin:100;durationin:2000;delayin:1000;" src="http://d2sribx23tmroi.cloudfront.net/wp-content/plugins/LayerSlider/static/img/blank.gif" data-src="http://d2sribx23tmroi.cloudfront.net/wp-content/uploads/2013/12/slide-a-1.png" alt="">
                <img class="ls-l" style="top:495px;left:217px;white-space: nowrap;" data-ls="offsetxin:0;offsetyin:100;durationin:2000;delayin:1000;" src="http://d2sribx23tmroi.cloudfront.net/wp-content/plugins/LayerSlider/static/img/blank.gif" data-src="http://d2sribx23tmroi.cloudfront.net/wp-content/uploads/2013/12/slide-a-2.png" alt="">
                <img class="ls-l" style="top:275px;left:217px;white-space: nowrap;" data-ls="offsetxin:0;offsetyin:100;durationin:2000;delayin:1000;" src="http://d2sribx23tmroi.cloudfront.net/wp-content/plugins/LayerSlider/static/img/blank.gif" data-src="<?php echo base_url(); ?>assets/themes/default/images/slide-a-3.png" alt="">
